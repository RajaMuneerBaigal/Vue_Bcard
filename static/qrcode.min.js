...
;(QR8bitByte.prototype = {
  ...
  (QRCodeModel.createData = function (t, e, r) {
    ...
    for (
      ...
      !(
        ...
        (n.put(QRCodeModel.PAD0, 8), n.getLengthInBits() >= 8 * s)
      );

    )
      n.put(QRCodeModel.PAD1, 8)
  ...
  (QRCodeModel.createBytes = function (t, e) {
    ...
    var R = new Array(c),
      p = 0
    for (u = 0; u < o; u++)
      for (s = 0; s < e.length; s++) u < i[s].length && (R[p++] = i[s][u])
    for (u = 0; u < n; u++)
      for (s = 0; s < e.length; s++) u < a[s].length && (R[p++] = a[s][u])
    return R
  })
for (
  var QRMode = {
...
;(QRCode.prototype.svg = function (t) {
  ...
  switch (t.container) {
    case 'svg':
      f && (T += '<?xml version="1.0" standalone="yes"?>' + i),
        (T +=

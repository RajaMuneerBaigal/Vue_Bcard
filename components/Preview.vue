    ...
    <div :id="`Theme${theme}`">
      ...
      >
        <head>
          ...
          <meta
            name="author"
            content=" VcardFile.app - An Digital Business Card Generator"
          />
          <meta name="url" content="https://vcardfile.app/" />
          <meta name="designer" content="vcardfile.app" />
          <meta
            property="og:title"
          ...
          <!-- prettier-ignore -->
          <script>
            src="http"==window.location.href.substr(0,4)&&"/"!=window.location.href.slice(-1)&&window.location.replace(window.location.href+"/");
          </script>
        ...
        <body id="body">
          ...
          <main
            :style="{
              ...
              // marginBottom: `${hasOnlyProfilePic ? 'rem' : '0'}`,
            }"
          >
          <img
  id="profilePhoto"
  :src="
    images.photo.url ? (PreviewMode ? images.photo.url : `./photo.${images.photo.ext}`) :
    images.photo1.url && !images.photo.url ? (PreviewMode ? images.photo1.url : `./photo1.${images.photo1.ext}`) :
    'photo.png'
  "
/>
            ...
            <img
              id="profilePhoto"
              v-if="images.photo1.url"
              :src="
                PreviewMode ? images.photo1.url : `./photo1.${images.photo1.ext}`
              "
            ...
            <div >
              <img
                id="logo1"
                v-if="images.logo1.url"
                :src="
                  PreviewMode ? images.logo1.url : `./logo1.${images.logo1.ext}`

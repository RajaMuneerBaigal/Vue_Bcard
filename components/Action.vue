<template>
  <div class="stepC flex mt-6">
    ...
    <div class="w-full">
      <input
        ref="input"
        class="px-4 w-full h-12 bg-black placeholder-gray-600 rounded-r border border-transparent transition-colors duration-200 focus:outline-none focus:border-gray-600 hover:border-gray-600 text-white"
        type="text"
    ...
    <button
      class="p-1 m-2 shrink-0 focus:outline-none bg-black rounded hover:bg-gray-700 focus:bg-gray-700 transition-colors duration-200"

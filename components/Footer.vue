<template>
  <footer class="mt-32 mx-4 flex flex-col">
    <div class="flex flex-col justify-center items-center ">
      <div
        class="logo w-12 ml-14"
        v-html="require(`~/assets/icons/logo-small.svg?include`)"
      ></div>
      <!-- <p class="font-extrabold leading-tight">
       ...
       <p class="font-extrabold text-xl mt-2 leading-tight">VCARDfile</p>
       -->
      
      <p class="mt-2 ml-40 mb-8 text-center text-gray-400">
      Made by
      <a

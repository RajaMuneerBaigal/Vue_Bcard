<template>
  <div class="flex mt-6">
    ...
    <div class="flex flex-wrap items-center">
      ...
      <button
        v-else
        class="p-1 m-2 shrink-0 bg-gray-900 focus:outline-none rounded hover:bg-gray-700 focus:bg-gray-700 transition-colors duration-200"

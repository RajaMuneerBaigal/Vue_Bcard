<template>
  <div class="flex flex-col w-full mt-6 bg-white text-white rounded">
    <div class="flex justify-between">
      <div class="flex items-center w-full">
        ...
        <div class="w-full">
          <input
            class="px-4 w-full h-12 bg-gray-700 placeholder-gray-600 transition-colors duration-200 border-b border-black focus:outline-none focus:border-gray-500 hover:border-gray-500"
            type="text"
            name="section title"
      ...
      <button
        class="p-1 m-2 shrink-0 bg-gray-700 focus:outline-none rounded hover:bg-gray-600 focus:bg-gray-600 transition-colors duration-200"

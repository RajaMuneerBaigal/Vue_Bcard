export default {
  ...
  meta: {
    ...
    // ogUrl: false,
    ogTitle: 'VCARDfile- A Digital Business Card Generator',
    ogDescription:
      'VCARDfile helps you create beautiful, responsive HTML-based digital business cards that can be hosted on your website.',
    ogSiteName: 'VCARDfile - A Digital Business Card Generator',
    theme_color: '#111827',
    author: 'VCARD File',
    lang: 'en',
    name: 'VCARDfile- A Digital Business Card Generator',
  },
  head: {
